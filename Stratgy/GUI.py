...
# Inputs
tk.Label(sidebar, text="Name:", bg="#f0f0f0").pack(anchor="w", padx=0)
name_entry = tk.Entry(sidebar)
name_entry.pack(fill=tk.X, padx=0, pady=2)

tk.Label(sidebar, text="Notes:", bg="#f0f0f0").pack(anchor="w", padx=0)
note_entry = tk.Text(sidebar, height=4)
note_entry.pack(fill=tk.X, padx=0, pady=2)
...
tk.Button(sidebar, text="📤 Export All", command=export_all, bg="#d0ffd0").pack(fill=tk.X, padx=0, pady=10)
